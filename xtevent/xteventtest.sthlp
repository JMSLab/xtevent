...
{phang}
{opt trend(#1)} tests for a linear trend from time period #1 before the policy change. It uses linear regression to estimate the trend. #1 must be less than 0.
